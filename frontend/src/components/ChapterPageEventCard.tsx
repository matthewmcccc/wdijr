...
interface ChapterPageEventCardProps {
    title: string;
    eventType: string;
    description: string;
    characters: string[]; 
        ...
        <div className="rounded-lg relative flex flex-col">
            <div className="flex flex-row items-center gap-2 mb-2">
                {eventType && eventIcons[eventType] ? (
                    <div
                        className="w-8 h-8 border border-[#228B22] p-1 rounded-full items-center justify-center shrink-0"
...
export default ChapterPageEventCard;