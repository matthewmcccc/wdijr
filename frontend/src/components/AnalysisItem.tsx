...
export default function AnalysisItem({ analysis_type, img, description, url }: AnalysisItemProps) {
    ...
    return (
        <div className="rounded-md w-3/4 mx-auto border border-gray-200 overflow-hidden cursor-pointer hover:shadow-lg transition-shadow duration-300" onClick={() => navigate(url || "/")}>
